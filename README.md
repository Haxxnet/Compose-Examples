...
- [Obsidian-Gitsync-Perlite](https://github.com/l4rm4nd/Obsidian-Gitsync-Perlite) - Continously sync Obsidian markdown notes from GitHub and publish it for the webs.
